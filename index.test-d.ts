...
expectType<string>(ansiEscapes.beginSynchronizedOutput);
expectType<string>(ansiEscapes.endSynchronizedOutput);
expectType<string>(ansiEscapes.synchronizedOutput('foo'));
